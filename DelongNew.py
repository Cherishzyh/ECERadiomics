...
pvalue_1 = DelongTest(np.array(pred1_list), np.array(pred2_list), np.array(label_list))
pvalue_2 = DelongTest(np.array(pred1_list), np.array(pred3_list), np.array(label_list))
pvalue_3 = DelongTest(np.array(pred1_list), np.array(pred4_list), np.array(label_list))
pvalue_4 = DelongTest(np.array(pred1_list), np.array(pred5_list), np.array(label_list))
pvalue_5 = DelongTest(np.array(pred2_list), np.array(pred3_list), np.array(label_list))
pvalue_6 = DelongTest(np.array(pred2_list), np.array(pred4_list), np.array(label_list))
pvalue_7 = DelongTest(np.array(pred2_list), np.array(pred5_list), np.array(label_list))
pvalue_8 = DelongTest(np.array(pred3_list), np.array(pred4_list), np.array(label_list))
pvalue_9 = DelongTest(np.array(pred3_list), np.array(pred5_list), np.array(label_list))
pvalue_10 = DelongTest(np.array(pred4_list), np.array(pred5_list), np.array(label_list))
